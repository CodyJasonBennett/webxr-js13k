      ...
      if (inputSource) {
        if (controller.targetRay) {
          ...
          if (inputPose !== null) {
            ...
            controller.targetRay.matrix.decompose(
              controller.targetRay.position,
              controller.targetRay.rotation,
              controller.targetRay.scale
            );
          }
        }
        ...
        if (controller.grip && inputSource.gripSpace) {
          ...
          if (gripPose !== null) {
            ...
            controller.grip.matrix.decompose(
              controller.grip.position,
              controller.grip.rotation,
              controller.grip.scale
            );
          }
        }
      }
